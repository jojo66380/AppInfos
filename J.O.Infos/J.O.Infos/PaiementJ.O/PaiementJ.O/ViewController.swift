...
class ViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    @IBAction func clickedValidationButton(_ sender: Any) {
        if montantTextField.text == "" || numCompte.text == "" {
            ...
            let alertVerif = UIAlertController(title: "Verification", message: "Êtes-vous sûr de vouloir retirer \(montantTextField.text!) du compte \(numCompte.text!)", preferredStyle: UIAlertControllerStyle.alert)
